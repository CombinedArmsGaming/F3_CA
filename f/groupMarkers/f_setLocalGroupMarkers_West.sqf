...
// This is not a huge problem, but be aware of it, and know that players will need to manually set radios to their channels as with TFAR.
	...
	["GrpNATO_A3",_ft, "AV", "ColorRed"] spawn f_fnc_localGroupMarker;
	...
	["GrpNATO_BV",_ft, "BV", "ColorBlue"] spawn f_fnc_localGroupMarker;
	...
	["GrpNATO_CV",_ft, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
