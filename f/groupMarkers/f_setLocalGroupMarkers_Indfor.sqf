...
// Markers seen by players in AAF slots.
	...
	["GrpCSAT_A3", _ft, "A3", "ColorRed"] spawn f_fnc_localGroupMarker;
	...
	["GrpCSAT_C3", _ft, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
	...
	["GrpCSAT_IFV1",  _ifv, "IFV1", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_IFV2",  _ifv, "IFV2", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_IFV3",  _ifv, "IFV3", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_IFV4",  _ifv, "IFV4", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_IFV5",  _ifv, "IFV5", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_IFV6",  _ifv, "IFV6", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_IFV7",  _ifv, "IFV7", "ColorOrange"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_IFV8",  _ifv, "IFV8", "ColorOrange"] spawn f_fnc_localGroupMarker;
	...
	["UnitCSAT_CO_M", _hq, "COM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	["UnitCSAT_DC_M", _hq, "DCM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	["UnitCSAT_ASL_M", _hq, "AM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	["UnitCSAT_BSL_M", _hq, "BM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	["UnitCSAT_CSL_M", _hq, "CM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
