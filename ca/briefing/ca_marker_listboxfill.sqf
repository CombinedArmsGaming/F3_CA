...
_edctrl = _display displayCtrl 1400; _edctrl ctrlSetText (format ["%1",(groupid ca_selectedgroup)]);
...
_MkrColor = (ca_selectedgroup) getVariable ["ca_groupcolor","ColorBlack"];
_MkrType = (ca_selectedgroup) getVariable ["ca_grouptype","b_hq"];
